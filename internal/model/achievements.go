...
func DefaultAchievements() []Achievement {
	return []Achievement{
		{ID: "first_feed", Name: "Primeira Refeição", Description: "Alimentou o Tama pela primeira vez", Icon: "🍽️"},
		{ID: "first_pet", Name: "Primeiro Carinho", Description: "Fez carinho no Tama pela primeira vez", Icon: "💕"},
		{ID: "first_exercise", Name: "Primeiro Exercício", Description: "Exercitou o Tama pela primeira vez", Icon: "💪"},
		{ID: "night_owl", Name: "Coruja Noturna", Description: "Sobreviveu 50 ticks", Icon: "🦉"},
		{ID: "centurion", Name: "Centurião", Description: "Sobreviveu 100 ticks", Icon: "🏛️"},
		{ID: "zen_master", Name: "Mestre Zen", Description: "Todos os stats acima de 70", Icon: "🧘"},
		{ID: "marathon", Name: "Maratonista", Description: "Exercitou 20 vezes", Icon: "🏃"},
		{ID: "glutton", Name: "Glutão", Description: "Alimentou 30 vezes", Icon: "🍔"},
		{ID: "hydrated", Name: "Hidratado", Description: "Deu água 30 vezes", Icon: "💧"},
		{ID: "cuddler", Name: "Carinhoso", Description: "Fez carinho 25 vezes", Icon: "🤗"},
		{ID: "troublemaker", Name: "Encrenqueiro", Description: "Irritou o Tama 15 vezes", Icon: "😈"},
		{ID: "evolved_child", Name: "Crescendo!", Description: "Evoluiu para Criança", Icon: "🌱"},
		{ID: "evolved_teen", Name: "Adolescente", Description: "Evoluiu para Adolescente", Icon: "🌿"},
